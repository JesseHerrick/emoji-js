...
(function() {
  ...
  loadEmoji = function() {
    var emoji, name, webpage, _fn, _i, _len, _ref, _results;
    webpage = document.body.innerHTML;
    _ref = Emoji.names;
    _fn = function() {};
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _fn();
      name = ":" + emoji + ":";
      _results.push(document.body.innerHTML = webpage.replace(name, "<img src='" + Emoji.name_to_path[emoji] + "' alt='" + name + "' class='emoji'>"));
    }
    return _results;
  };
